...
class Personagem:
    def __init__(self, tela, debug = False):
        ...
        self.profissoes = []
        self.zaaps = []
        self.viagem = new Viagem(debug = self.debug, tela = self.tela) 
...
#             click(Pattern("images/viagem/images/viagem/1593921113688.png").targetOffset(70,1))
#             type(key)
#             if exists("images/viagem/images/viagem/1593924952372.png",0.2):
#                 self.zaaps.append(self.all_zaaps[key])
                
#                 print(self.zaaps)
#             click("images/viagem/images/viagem/1593923807674/1593923807674.png")
